...
public class DynamicSelectionCell extends AbstractInputCell<Pair<Long, String>, Pair<Long, String>> {
  ...
  public void removeOption(Pair<Long, String> op){
      options.remove(indexForOption.get(op));
      refreshIndexes();
  }
  ...
  @Override
  public void onBrowserEvent(Context context, Element parent, Pair<Long, String> value,
      NativeEvent event, ValueUpdater<Pair<Long, String>> valueUpdater) {
