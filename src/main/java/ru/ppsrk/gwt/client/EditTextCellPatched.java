 ...
 */
public class EditTextCellPatched extends
    AbstractEditableCell<String, EditTextCellPatched.ViewData> {
   ...
   *          instance
   */
  public EditTextCellPatched(SafeHtmlRenderer<String> renderer) {
