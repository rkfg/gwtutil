...
public class BinaryRequestBuilder {
     ...
     */
    public BinaryRequestBuilder(Method httpMethod, String url) {
     ...
     *             if the httpMethod or the URL are null
     */
    protected BinaryRequestBuilder(String httpMethod, String url) {
    ...
    private Request doSend(String requestData, final RequestCallback callback) throws RequestException {
        BinaryXMLHttpRequest xmlHttpRequest = (BinaryXMLHttpRequest) BinaryXMLHttpRequest.create();
        ...
        try {
            if (!binary) {
                ...
                xmlHttpRequest.sendAsBinary(requestData);
            }
        } catch (JavaScriptException e) {
            throw new RequestException(e.getMessage());
        }
